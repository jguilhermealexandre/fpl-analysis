/* ============================================
   ...
   ============================================ */
        ...
        function buildSuggestedMoves(starters, injuredStarters, doubtfulStarters, capAnalysis) {
            ...
            /* Template gaps used to be suggested here, ranked by how much of
               the whole game owned a player you did not have. Two things were
               wrong with that. It is not a move — "Do this week" is a list of
               actions, and "somebody else owns Salah" is not one of them. And
               global ownership is the wrong measure of a gap: it is diluted
               across thirteen million teams, most of whom are not playing the
               same game as anyone reading this.

               scripts/eo-layer.js answers it properly, against the tier you are
               actually competing with, and it lives in the Transfer Wizard where
               a gap can be acted on rather than merely noted. */
