/* ============================================
   ...
   ============================================ */
        ...
        // Expected FPL points for the coming gameweek, built from the scoring rules
        // rather than read off FPL's ep_next. ep_next is heavily regressed early in a
        // season — right now it's capped at 4.0 across the whole game and averages
        // 1.95 for players with minutes — so summing it produced a Starting XI
        // projection in the low 30s (a real XI scores ~45-60) and left every player
        // bunched between 1.5 and 4.0, which is useless for comparing them.
        //
        // Returns the component breakdown so the same numbers can justify captaincy
        // and bench-swap advice in the insights panel.
        // The clean-sheet and per-90 models live here rather than inline in the
